...
const AdminPanel = () => {
  ...
  const mockAnalyses = [
    { id: 101, user: 'Alex Johnson', matchScore: 78, skills: 12, date: '2023-10-15', status: 'Completed' },
    { id: 102, user: 'Maria Garcia', matchScore: 92, skills: 18, date: '2023-10-18', status: 'Completed' },
    { id: 103, user: 'David Smith', matchScore: 65, skills: 8, date: '2023-10-10', status: 'Completed' },
    { id: 104, user: 'Sarah Williams', matchScore: 85, skills: 15, date: '2023-10-20', status: 'Completed' },
    { id: 105, user: 'James Brown', matchScore: 95, skills: 22, date: '2023-10-22', status: 'Completed' },
  ];
  ...
  const tabs = [
    ...
    // Removed 'reports' tab as the share report functionality is not working
  ];
  ...
  return (
    <div className="min-h-screen container mx-auto px-4 sm:px-6 py-8">
      <div className="max-w-7xl mx-auto">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-4">Skills Matched</th>
                ...
                <tbody>
                  {mockAnalyses.map((analysis) => (
                    <tr key={analysis.id} className="border-b hover:bg-muted/50">
                      ...
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 bg-green-500/10 text-green-500 rounded-full text-sm">
                          {analysis.status}
                        </span>
                      </td>
                    </tr>
        ...
        {/* Removed Reports Tab content as the share report functionality is not working */}
      </div>
    </div>
  );
};
